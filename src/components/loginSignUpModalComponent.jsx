...
function LoginSignUpModalComponent(){
    ...
    <div className='LoginSignUpModalComponent-div'>
        ...
        <div className='LoginSignUpModalComponent-div-lower'>
            <button className='LoginSignUpModalComponent-div-lower-login'>Iniciar sesión</button>
            <button className='LoginSignUpModalComponent-div-lower-signup'>Crear una cuenta</button>
        </div>
    </div>
    )
}
